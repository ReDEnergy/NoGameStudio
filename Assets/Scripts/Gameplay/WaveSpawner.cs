...
public class WaveSpawner : MonoBehaviour
{
	...
	void Start ()
	{
		...
		_startPoints[4] = mostTop + mostRight;
		_startPoints[5] = mostTop - mostRight;
		_startPoints[6] = - mostTop + mostRight;
		_startPoints[7] = - mostTop - mostRight;
	...
	void _SpawnWave()
	{
		...
		Destroy( wave.gameObject, waveLife );
	}
}
